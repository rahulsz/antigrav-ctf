...
export const BackgroundBeams = ({ className }: { className?: string }) => {
  ...
  useEffect(() => {
    ...
    paths.forEach((path, i) => {
      ...
      path.style.animation = `dash 8s ease-in-out ${i * 0.15}s infinite alternate`;
    });
  }, []);
    ...
    >
      ...
      >
        <style>
          {`
            @keyframes dash {
              0% { stroke-dashoffset: var(--dash-length, 2000); opacity: 0; }
              30% { opacity: 0.3; }
              50% { opacity: 0.6; }
              70% { opacity: 0.3; }
        ...
        <defs>
          <linearGradient id="beam-gradient-0" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="50%" stopColor="var(--cyan-glow)" stopOpacity="0.6" />
          ...
          <linearGradient id="beam-gradient-1" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="50%" stopColor="var(--violet-glow)" stopOpacity="0.4" />
